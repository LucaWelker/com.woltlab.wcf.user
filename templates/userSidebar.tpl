	...
	<fieldset>
		...
		<div>
			...
			{if $followingCount > 10}
				<a id="followingAll" class="button small more javascriptOnly">{lang}wcf.user.profile.userList.showAll{/lang}</a>
			{/if}
		</div>
	</fieldset>
{/if}
...
{if $followerCount}
	<fieldset>
		...
		<div>
			...
			{if $followerCount > 10}
				<a id="followerAll" class="button small more javascriptOnly">{lang}wcf.user.profile.userList.showAll{/lang}</a>
			{/if}
		</div>
	</fieldset>
{/if}
...
{if $visitorCount}
	<fieldset>
		...
		<div>
			...
			{if $visitorCount > 10}
				<a id="visitorAll" class="button small more javascriptOnly">{lang}wcf.user.profile.userList.showAll{/lang}</a>
			{/if}
		</div>
	</fieldset>
{/if}
