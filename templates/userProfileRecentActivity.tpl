<ol id="recentActivity" class="wcf-recentActivity">
	{foreach from=$eventList item=event}
		<li class="wcf-container">
			<a href="{link controller='User' object=$event->userProfile}{/link}" title="{$event->getUserProfile()->username}" class="wcf-containerIcon wcf-userAvatarFramed">{@$event->userProfile->getAvatar()->getImageTag(48)}</a>
