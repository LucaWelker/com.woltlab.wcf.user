...
class UserFollowingList extends UserFollowerList {
	...
	public function __construct() {
		...
		$this->sqlSelects .= "user_avatar.*, user_follow.followID, user_follow.followUserID AS userID, user_table.username, user_table.email, user_table.disableAvatar, user_table.enableGravatar";
