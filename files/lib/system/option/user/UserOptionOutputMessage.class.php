...
/**
 * UserOptionOutputMessage is an implementation of IUserOptionOutput for a formatted textarea value.
 *
 * @author	Marcel Werk
 ...
 */
class UserOptionOutputMessage implements IUserOptionOutput {
	/**
